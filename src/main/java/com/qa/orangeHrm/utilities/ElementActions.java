...
//perform webelement actions
	public WebElement getElement(By locator) {
		return ws.waitForVisibility(locator);
	}
	public void doClick(By locator) {
		ValidationHelper.ValidateLocator(locator, "doClick");
		try {
			ws.waitForClickable(locator).click();			
		} catch (Exception e) {
			throw new ElementExceptions("===[doClick] the specified locator"+locator
					+" is not matching with any element in the webpage===");
		}
	}
	public void doClear(By locator) {
		ValidationHelper.ValidateLocator(locator, "doClear");
		try {
	...
	public void doEnterValue(String value,By locator) {
		ValidationHelper.ValidateLocator(locator, "doEnterValue");
	...
	public boolean checkElementSelected(By locator) {
		...
		try {
			...
			throw new ElementExceptions("===[checkElementSelected] the specified locator"+locator
					+" is not matching with any element in the webpage===");		
		}
