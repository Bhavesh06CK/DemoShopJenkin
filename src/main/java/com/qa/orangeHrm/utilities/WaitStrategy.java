...
//		super(driver);
		fw= new FluentWait<WebDriver>(driver)
				.withTimeout(Duration.ofSeconds(FrameworkConstants.defaultWaitTime))
	...
	public Boolean waitForTitle(String expectedTitle) {
		return fw.until(ExpectedConditions.urlContains(expectedTitle));
	}
	public Alert waitForAlert(String expectedTitle) {
